...
var _excluded = ["id", "data", "isDataEqual", "type", "visible", "children", "axisId", "requiresAxis", "jsxOptions"],
    _excluded2 = ["visible", "data"],
    _excluded3 = ["id", "data"];
  ...
  */
  ...
  useEffect(function () {
    ...
    var visible = seriesProps.visible,
        ...
        rest = _objectWithoutProperties(seriesProps, _excluded2);
